        ...
        <form onSubmit={handleSubmit}>
          <div className="flex space-x-4 mb-4">
            <div className="w-1/2 relative">
              <input type="text" id="fname" name="fName" value={formData.fName} onChange={handleChange} maxLength="20" pattern="[a-zA-Z]+" 
            ...
            <div className="w-1/2 relative">
              <input type="text" id="lname" name="lName" value={formData.lName} onChange={handleChange} maxLength="20" pattern="[a-zA-Z]+" 
                className="pl-10 block w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-200 focus:border-pink-300" 
          ...
          <div className="mb-4 relative">
            <input type="password" id="password" name="password" value={formData.password} onChange={handleChange} pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*\W).{8,16}"
              className="pl-10 block w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-200 focus:border-pink-300" 
              placeholder="Password" required />
          </div>
          <div className="mb-6 relative">
            <input type="password" id="cPassword" name="cPassword" value={formData.cPassword} onChange={handleChange} pattern="(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*\W).{8,16}"
              className={`pl-10 block w-full px-4 py-2 bg-gray-50 border ${passwordError ? 'border-red-500 focus:ring-red-200' : 'border-gray-300 focus:ring-pink-200'
              } rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:border-pink-300`} placeholder="Confirm Password" required /> {passwordError && (
